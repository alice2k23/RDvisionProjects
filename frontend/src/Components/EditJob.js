...
function EditJob() {
    ...
    const handleOnClick = () => toast("Job Posted Succesfully");
                ...
                <div className="container px-5 mx-auto">
                    ...
                    <div className="lg:w-1/2 md:w-2/3 mx-auto">
                        <form onSubmit={handleSubmit} className="flex flex-wrap -m-2">
                            ...
                            <div className="p-2 w-full">
                                {loading ? <div className='w-full flex justify-center'><div class="loader"></div></div> : <button type="submit" className="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Post Job</button>}
                            </div>
                        </form>
                    </div>
                </div>
